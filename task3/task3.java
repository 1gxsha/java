...
public class task3 {
    public static void main(String[] args) {
        ...
        float[] a = {xa,ya};
        System.out.println("Координаты первой точки: " + "[" + a[0] + "," + a[1] + "]");
        float xb = scanner.nextInt();
        float yb = scanner.nextInt();
        float[] b = {xb,yb};
        System.out.println("Координаты второй точки: " + "[" + b[0] + "," + b[1] + "]");
        float xc = scanner.nextInt();
        float yc = scanner.nextInt();
        float[] c = {xc,yc};
        System.out.println("Координаты третьей точки: " + "[" + c[0] + "," + c[1] + "]");
        float[] answer = {0,0};
